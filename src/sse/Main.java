...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        options.addOption("m", false,
                "Generates the SuffixVectors in memory");
        ...
        options.addOption("b", false,
                "Split in blocks. Default turned off");
        options.addOption("enc", false, "Turns on block encryption");
